...
```
 ...
 docker run --name blog-server_container -d -p 8072:8072 --link mysql_container:localhost --link redis_container -v $PWD/blog-server-tamcat/webapps:/usr/local/tomcat/webapps blog-server_image
```
