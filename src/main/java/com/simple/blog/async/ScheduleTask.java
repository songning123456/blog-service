...
public class ScheduleTask {
    ...
    private  List<String> labels = Arrays.asList(
            ...
            "图片资源", "Photoshop", "PHP", "API", "Sublime Text", "设计师", "数据挖掘", "操作系统", "阿里巴巴", "MongoDB",
            "gradle", "Material Design", "数据可视化", "安全", "招聘", "Go", "Swift", "Vuex", "MVVM", "RxJava",
            "Xcode", "敏捷开发", "运维", "Markdown", "动效", "字体", "腾讯", "Objective-C", "云计算", "Spring",
            "运营", "物联网", "Canvas", "深度学习", "Icon", "爬虫", "C++", "虚拟现实", "HTTPS", "Debug",
            "Eclipse", "电子书", "Ubuntu", "Sketch", "翻译", "NPM", "微服务", "JSON", "测试", "配色",
            "Ajax", "DOM", "C", "源码", "Facebook", "VIM", "SCSS", "稀土", "TypeScript", "Apache",
            "游戏", "Redux", "maven", "Kotlin", "Visual Studio Code", "负载均衡", "SVG", "Windows", "SEC", "区域链",
            "支付宝", "函数式编程", "Gulp", "增强现实", "Microsoft", "SQLite", "Flutter", "浏览器", "Express", "Unity 3D",
            "SQL", "远程工作", "Firefox", "APK", "Atom", "Promise", "Webkit", "IntelliJ IDEA", "Hadoop", "Spring boot",
            "嵌入式", "JVM", "机器人", "编译器", "神经网络", "响应式编程", "投资", "Django", "科幻", "百度"
    );
